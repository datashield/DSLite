...
#'
#' @param conns \code{\link{DSConnection-class}} object or a list of \code{\link{DSLiteConnection-class}}s.
#' @param symbol Symbol name identifying the variable in the \link{DSLiteServer}'s "server-side" environment(s).
#' @return The data value or a list of values depending on the connections parameter.
#' @export
