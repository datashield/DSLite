        ...
        if (!is.na(pack$AggregateMethods)) {
          ...
          for (m in names(methods)) {
            ...
            if (length(idx) > 0) {
              ...
              warning("Ignoring aggregate method '", m, "' from package '", as.character(pack$Package), "' because it is already defined by package '", pkg, "'!")
            } else {
        ...
        if (!is.na(pack$AssignMethods)) {
          ...
          for (m in names(methods)) {
            ...
            if (length(idx) > 0) {
              ...
              warning("Ignoring assign method '", m, "' from package '", as.character(pack$Package), "' because it is already defined by package '", pkg, "'!")
            } else {
